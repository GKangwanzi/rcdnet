                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <label for="basicInput">Activity Topic</label>
                                <input type="text" name="topic" class="form-control" placeholder="Enter activity topic">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                <label for="basicInput">Beneficiaries</label>
